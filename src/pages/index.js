      ...
      <Layout>
        ...
        <HomeLayout>
          ...
          <div style={{ textAlign: `center`, padding: `12px` }}>
            ...
            <p>
              I'm also interested in <Link href="/blog/"><a className="link">Blogging</a></Link> about my personal experiences and tech stuff. And writing stories just for fun.
            </p>
            <p>
              Currently I'm developing personal projects and I'm available to hire. Feel
              free to <Link href="/contact/"><a className="link">contact</a></Link> with me.
            </p>
          </div>
        </HomeLayout>
      </Layout>
